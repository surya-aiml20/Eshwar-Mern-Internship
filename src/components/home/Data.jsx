...
const Data = () => {
  return (
    <div className='home__data'>
        <h1 className='home__title'>Surya J</h1>
        <h3 className='home__subtitle'>Software Engineer</h3>
        <p className='home__description'>I'm a software engineer with a passion for building scalable and efficient software solutions.</p>
